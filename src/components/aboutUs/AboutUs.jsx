      ...
      <div className="mx-auto max-w-[1440px] px-6 sm:px-10 lg:px-16 xl:px-20">
        ...
        <div className="mx-auto mt-10 sm:mt-12 max-w-[960px]">
          ...
          >
            ...
            >
              West Valley Medical Clinic endeavours to help you look and feel your best. Located in Pokhara, we offer unrivalled expertise in a variety of aesthetic, medical, and dental services.
            </p>
            ...
            <div className="space-y-4 text-[15px] sm:text-[16px] leading-[1.8] text-[#536273] text-justify">
              <p>
                We offer a wide range of treatments and services, including hair transplants, aesthetic and skin care, hair recovery treatments, endocrine and metabolic care, and more. Our team is composed of highly skilled professionals with years of experience in their respective specialties. They are equipped with state-of-the-art technology to provide you with unparalleled services. Along with cutting-edge technology and professional guidance, we provide exquisite service to patients in order to ensure their safety, comfort, and the best results.
              </p>
            </div>
          </div>
        </div>
